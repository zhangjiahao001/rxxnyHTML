...
<div class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">产品系列：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="" id="" placeholder="最快速度" value="" class="input-text" style=" width:25%">
				km/h
				<input type="text" name="" id="" placeholder="续航时间" value="" class="input-text" style=" width:25%">
				小时
				</div>
		</div>
		<div class="row cl">
