...
<body>
<div>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统统计 <span class="c-gray en">&gt;</span> 交易记录 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<tr class="text-c va-m">
						...
						<td><u style="cursor:pointer" class="text-primary" onclick="deal_show('张三','deal-show.html','10001','360','400')">张三</u></td>
						<td>2018-12-12</td>
						<td>1a</td>
...
/*用户-查看*/
function deal_show(title,url,id,w,h){
